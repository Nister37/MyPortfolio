...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Technical blog article';
  ...
  attributes: {
    ...
    language: Schema.Attribute.Enumeration<['en', 'pl']> &
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    publishedAtCustom: Schema.Attribute.Date;
...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['Education', 'Project', 'Work', 'Hackathon']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    architecture: Schema.Attribute.Blocks;
    ...
    hardestProblem: Schema.Attribute.Blocks;
    highlights: Schema.Attribute.JSON;
    lessonsLearned: Schema.Attribute.Blocks;
    ...
    > &
      Schema.Attribute.Private;
    myRole: Schema.Attribute.Blocks;
    order: Schema.Attribute.Integer;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    shortBio: Schema.Attribute.Blocks & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Backend', 'DevOps', 'Frontend', 'AI', 'Database']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    level: Schema.Attribute.Enumeration<['Strong', 'Good', 'Learning']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
